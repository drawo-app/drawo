...
export const useInteraction = ({
  ...
  const handleShapeSloppinessChange = useCallback(
    (ids: string[], sloppiness: "architect" | "artist" | "cartoonist") => {
      setScene((currentScene) =>
        updateShapeElementsSloppiness(currentScene, ids, sloppiness),
      );
    },
    [setScene],
  );
