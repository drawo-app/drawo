...
import "./Timer.css";
import "../MusicBar/MusicBar.css";
import { HourglassLine, Pause, Play, Stop } from "@solar-icons/react";
import { TIMER_STORAGE_KEY } from "../../state/constants";
